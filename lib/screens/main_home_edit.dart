...
class MainHomeEdit extends StatefulWidget {
  ...
  MainHomeEdit({Key? key,this.news, this.breakfast, this.lunch,this.dinner,this.originalFood1,this.originalFood2,this.originalFood3}) : super(key: key){
    sendData = SendData(news, breakfast, lunch, dinner,originalFood1,originalFood2,originalFood3);
  }
...
class SendData {
  ...
  dynamic? originalFood2;
  dynamic? originalFood3;
  SendData(this.news,this.breakfast,this.lunch,this.dinner,this.originalFood1,this.originalFood2,this.originalFood3){}
...
/********************************************************************/
  ...
  Future initNews3() async {
    ...
    uri9 = Uri.parse('http://10.0.2.2:8000/api/nutrient/'+dinner+'/'+news[2][1]+'/'+news[2][2]);
    initOriginalAsynk2();
  }
...
/********************************************************************/
  ...
  Future<void> _navigateAndDisplaySelection_lunch3(BuildContext context) async {
    ...
    setState(() {
      news[1][2] = foodName;
      news[1][3] = double.parse(foodKcal) + originalFood[4]["KCAL"] + originalFood[3]["KCAL"];
  ...
  Future<void> _navigateAndDisplaySelection_dinner(BuildContext context) async {
    ...
    setState(() {
      ...
      dinner = foodName;
      news[2][3] = double.parse(foodKcal) +
          originalFood[7]["KCAL"] +
          originalFood[8]["KCAL"];
    });
  }
            ...
            Container(
                ...
                Container(
                  child : ElevatedButton(
                    child: Text("수정완료"),
                    onPressed: () {/********************************************************************/
                      Navigator.pop(context, SendData(news, breakfast, lunch, dinner,originalFood1,originalFood2,originalFood3));
